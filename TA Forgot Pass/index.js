...
chatServer.listen(6000); // making chatServer to listen on port 5000
...
app.use(sassmiddleWare({
  /* old before getiing in enviroment.js file  
    ...
    */
    ...
    debug:false, // this will be set ture if we need to display error if we find any issue while converting scss file to css
    outputStyle:'extended',
    prefix:'/css' // this for node server to find scss file i.e for layoyt 
